...
var _global = _interopRequireDefault(__webpack_require__(305));
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(15)(proto, TO_PRIMITIVE, __webpack_require__(218));
...
var $export = __webpack_require__(0);
var flattenIntoArray = __webpack_require__(281);
var toObject = __webpack_require__(11);
var toLength = __webpack_require__(7);
var aFunction = __webpack_require__(19);
...
var has = __webpack_require__(317);
var PROTOTYPE = 'prototype';
...
// CONCATENATED MODULE: ./wp-content/themes/zander/js/app/HoverImage.js
...
var HoverImage_HoverImage = /*#__PURE__*/function () {
  function HoverImage() {
    _classCallCheck(this, HoverImage);

    console.log(jquery_default()('[data-featured-image'));
    jquery_default()('[data-featured-image').on('mouseenter', this.activateImage);
    jquery_default()('[data-featured-image').on('mouseleave', this.deactivateImage);
  }

  _createClass(HoverImage, [{
    key: "activateImage",
    value: function activateImage() {
      jquery_default()('.image-container img').attr('src', this.dataset.featuredImage).addClass('active-img');
    }
  }, {
    key: "deactivateImage",
    value: function deactivateImage() {
      // $('.image-container img').attr('src', this.dataset.featuredImage);
      jquery_default()('.image-container img').removeClass('active-img');
    }
  }]);
...
new HoverImage_HoverImage();
// CONCATENATED MODULE: ./wp-content/themes/zander/js/app/Menu.js
...
var Menu_Menu = /*#__PURE__*/function () {
  function Menu() {
    ...
    jquery_default()('.menu-trigger-wrapper').on('click', this.activateMenu);
    jquery_default()(document).on('mouseup', function (e) {
  ...
  Menu_createClass(Menu, [{
    ...
    value: function activateMenu() {
      jquery_default()('body').hasClass('menu-active') ? jquery_default()('body').removeClass('menu-active') : jquery_default()('body').addClass('menu-active');
    }
  }, {
    key: "closeMenu",
    value: function closeMenu(e) {
      var container = jquery_default()('.menu-social, .menu-trigger-wrapper');

      if (!container.is(e.target) && container.has(e.target).length === 0 && window.innerWidth >= 1024) {
        jquery_default()('body').removeClass('menu-active');
      }
    }
  }]);
...
var barba_umd = __webpack_require__(45);
...
// CONCATENATED MODULE: ./wp-content/themes/zander/js/app/PopulateImage.js
function PopulateImage_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function PopulateImage_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function PopulateImage_createClass(Constructor, protoProps, staticProps) { if (protoProps) PopulateImage_defineProperties(Constructor.prototype, protoProps); if (staticProps) PopulateImage_defineProperties(Constructor, staticProps); return Constructor; }
...
var PopulateImage_PopulateImage = /*#__PURE__*/function () {
  function PopulateImage(image, container, index) {
    PopulateImage_classCallCheck(this, PopulateImage);

    this.image = {
      el: image,
      src: image.dataset.triggerImage,
      scrollContainer: container,
      target: jquery_default()('.image-container img'),
      targetContainer: jquery_default()('.image-container'),
      index: index
    };
    this.createImage();
  ...
  PopulateImage_createClass(PopulateImage, [{
    key: "checkPosition",
    value: function checkPosition() {
      ...
      ScrollTrigger.create({
        ...
        onEnter: function onEnter() {
          _this.image.target.attr('src', _this.image.src);
        },
    ...
    key: "activateImage",
    value: function activateImage() {
      jquery_default()('.image-container img').attr('src', this.image.dataset.triggerImage);
    }
  }]);
...
// CONCATENATED MODULE: ./wp-content/themes/zander/js/app/TitlePosition.js
function TitlePosition_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function TitlePosition_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function TitlePosition_createClass(Constructor, protoProps, staticProps) { if (protoProps) TitlePosition_defineProperties(Constructor.prototype, protoProps); if (staticProps) TitlePosition_defineProperties(Constructor, staticProps); return Constructor; }
...
var TitlePosition_Essay = /*#__PURE__*/function () {
  function Essay() {
    TitlePosition_classCallCheck(this, Essay);

    this.essayTitle = {
      container: jquery_default()('[data-essay-header'),
      title: jquery_default()('[data-essay-title'),
      meta: jquery_default()('[data-essay-meta'),
      pubTable: jquery_default()('[data-publication-table')
    };
    this.header = {
      postType: jquery_default()('[data-post-type'),
      postTypeTarget: jquery_default()('[data-post-type-target'),
      postTitle: jquery_default()('[data-post-title-target'),
      mainLogo: jquery_default()('[data-main-logo'),
      shortLogo: jquery_default()('[data-short-logo'),
      pubTable: jquery_default()('[data-publication-table-target')
    };
    this.images = jquery_default()('[data-trigger-image]');
    this.bindEvents();
  }

  TitlePosition_createClass(Essay, [{
    key: "bindEvents",
    ...
    value: function watchTitle() {
      ...
      jquery_default()(window).on('scroll', function (event) {
        var title = _this.essayTitle.container[0].getBoundingClientRect();

        var headerTitle = _this.header.postType[0].getBoundingClientRect();

        var pubTable = _this.essayTitle.pubTable[0].getBoundingClientRect();

        if (title.y <= headerTitle.y + headerTitle.height) {
          _this.header.postType.addClass('opacity-0');

          _this.header.postTypeTarget.removeClass('opacity-0');

          _this.header.mainLogo.css('width', 0);

          _this.header.shortLogo.removeClass('opacity-0');

          _this.header.postTitle.removeClass('opacity-0');

          _this.header.pubTable.removeClass('opacity-0');
        } else {
          _this.header.postType.removeClass('opacity-0');

          _this.header.postTypeTarget.addClass('opacity-0');

          _this.header.shortLogo.addClass('opacity-0');

          _this.header.mainLogo.css('width', 'auto');

          _this.header.postTitle.addClass('opacity-0');

          _this.header.pubTable.addClass('opacity-0');
        } // if (title.y <= 0) {
    ...
    value: function getImages() {
      ...
      this.images.map(function (index, image) {
        return new PopulateImage_PopulateImage(image, jquery_default()(window), index);
      });
    }
  }, {
    key: "titleView",
    value: function titleView(elem) {
      console.log(elem);
...
new TitlePosition_Essay();
// CONCATENATED MODULE: ./wp-content/themes/zander/js/main.js
/**
 * main.js
...
barba_umd_default.a.hooks.before(function () {
  barba_umd_default.a.wrapper.classList.add('is-animating');
});
barba_umd_default.a.hooks.after(function () {
  barba_umd_default.a.wrapper.classList.remove('is-animating');
});
...
/***/ })
/******/ ]);
//# sourceMappingURL=zander-0382058f225e0a30db74.js.map