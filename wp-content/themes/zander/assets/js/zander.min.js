...
var barba_umd = __webpack_require__(317);

// CONCATENATED MODULE: ./js/app/HoverImage.js
/**
 * HoverImage.js
 */

class HoverImage_HoverImage {
  constructor() {
    jquery_default()('[data-featured-index').on('mouseenter', this.activateImage);
    jquery_default()('[data-featured-index').on('mouseleave', this.deactivateImage);
  }

  activateImage() {
    jquery_default()(`[data-featured-image="${this.dataset.featuredIndex}"]`).addClass('active-img');
  }

  deactivateImage() {
    jquery_default()(`[data-featured-image="${this.dataset.featuredIndex}"]`).removeClass('active-img');
  }

}
// CONCATENATED MODULE: ./js/app/Menu.js
/**
 * Menu.js
 */
...
class Menu_Menu {
  constructor() {
    ...
    jquery_default()(document).on('mouseup', e => this.closeMenu(e));
  }
  ...
  closeMenu(e) {
    let container = jquery_default()('.menu-social, .menu-trigger-wrapper');
...
// CONCATENATED MODULE: ./js/app/PopulateImage.js
/**
 * HoverImage.js
 */
...
class PopulateImage_PopulateImage {
...
// CONCATENATED MODULE: ./js/app/TitlePosition.js
/**
 * TitlePosition.js
 */


class TitlePosition_Essay {
  constructor() {
    this.essayTitle = {
  ...
  watchTitle() {
    jquery_default()(window).on('scroll', event => {
  ...
  getImages() {
    ...
    this.images.map((index, image) => new PopulateImage_PopulateImage(image, jquery_default()(window), index));
  }
...
// CONCATENATED MODULE: ./js/app/Clock.js
/**
 * Clock.js
 */
...
// CONCATENATED MODULE: ./js/app/Controller.js
/**
 * Controller.js
 */
...
class Controller_Controller {
  ...
  init() {
    ...
    new Menu_Menu(); // new PopulateImage();
...
// CONCATENATED MODULE: ./js/app/Marquee.js
/**
 * Boilerplate.js
 */
...
var gsap_gsapWithCSS = gsap.registerPlugin(CSSPlugin) || gsap,
    // to protect from tree shaking
gsap_TweenMaxWithCSS = gsap_gsapWithCSS.core.Tween;

// EXTERNAL MODULE: ./node_modules/typewriter-effect/dist/core.js
var core = __webpack_require__(318);

// CONCATENATED MODULE: ./js/app/HomePage.js
/**
 * Homepage.js
 */
...
class HomePage_Homepage {
  constructor() {
    if (!jquery_default()('.home-wrapper').length) {
      return;
    }

    jquery_default()(document).ready(() => {
      setTimeout(() => {
        var tl = gsap_gsapWithCSS.timeline(); // tl.fromTo('.passport-information', { opacity: 0, y: 15 }, { opacity: 1, y: 0} );
...
new Controller_Controller(); // barba.hooks.before(() => {
